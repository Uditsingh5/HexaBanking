...
/**
 * - Lookup Account route (public to authenticated users for transfer destination validation)
 * - GET /api/account/lookup/:accountId
 */
router.get("/lookup/:accountId", authMiddleware, accountController.lookupAccountController);
